	...
	foreach ($events['events'] as $event) {
		...
		if ($event['type'] == 'message' && $event['message']['type'] == 'text') {
			...
			if ($text == 'สวัสดี' || $text == 'หวัดดี') {
				...
				# code...
				$a = ['เพื่อนเรียกทำไมไม่ตอบ งงใจ', 'โป เพื่อนเรียกอ่ะ', 'คนนี้เค้าเด็กนิติ พูดจาอะไรระวังกันหน่อยนะ', 'อยุธยากุ้งเผาอร่อยดี'];
				$messages = getMessage($a);
				...
				$a = ['ชอบอุทานว่า hee ไม่ดีเลย not good', 'เพื่อนเรียกอะไม่ได้ยินเหรอ', 'ฮัลโหล เพื่อนเรียกเห้ย', 'มีหมาชื่อปลาหมึก อยากเป็นเพื่อนด้วยจัง', 'เพื่อนเรียกแล้วจะเฉยชาไปไย'];
