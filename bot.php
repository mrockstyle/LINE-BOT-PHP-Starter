	...
	foreach ($events['events'] as $event) {
		...
		if ($event['type'] == 'message' && $event['message']['type'] == 'text') {
			...
			if ($text == 'สวัสดี' || $text == 'หวัดดี') {
				...
				# code...
				$a = ['กำเลยกำบน', 'กำใดใครก่อ..', 'กำ หรือ กรรม อ่ะ ตกภาษาไทยกันหมดแล้วพวกมนุษย์', 'กำ กำตะถาวร'];
				$messages = getMessage($a);
			}elseif ($text == 'ไม่' || $text == 'ไม่ไป' || $text == 'ไม่อ่ะ' || $text == 'ไม่อะ') {
				# code...
				$a = ['ไม่ นี่ต้องเป็นคนที่โปเคยชอบแน่ๆ นั่นมุ่ยมั้ยหล่ะ!!!! แอ่แฮร่!!!!', 'ทำไมต้องปฏิเสธเพื่อนหล่ะ แย่จริงๆเลย', 'ไม่ ไม่ ไม่ ไม่ ไม่ โอ้ไม่มีเธอ!! อยากเจออยากเจ๊อ', 'ไม่หน้ามึงดิ', 'ไม่? ทำไมหล่ะ', 'Whyyyyyyyyyyyyyy'];
				$messages = getMessage($a);
			}elseif ($text == 'อิอิ') {
				# code...
				...
				# code...
				$a = ['ขำมากดิ', 'สนุกเค้าแหละ', 'ฮานามิ ข้าวเกรียบรวยเพื่อน', 'ฮาจิบังราเมง ต้องมีเครื่องหมายเลข8', '555555555555555555555555555', 'ขำด้วยดิ 555555555555555555'];
				$messages = getMessage($a);
			}elseif ($text == 'ลาเต้') {
				# code...
				...
				# code...
				$a = ['ติดสาว', 'แม่ทำกับข้าวไว้แล้วแน่ๆ เลยไม่มาตอบ', 'นราธิป เพื่อนเรียกแล้ว', 'ฮัลโหล นราธิป', 'เค้าไม่ตอบหรอกถ้าไม่ใช่สาวสวยพิมพ์ไปหา', 'นุ๊กแพรว นุ๊กแพรว นุ๊กแพรว นุ๊กแพรว นุ๊กแพรว นุ๊กแพรว นุ๊กแพรว นุ๊กแพรว นุ๊กแพรว นุ๊กแพรว นุ๊กแพรว นุ๊กแพรว','วันนี้ไป sweet addict รึเปล่าละ'];
