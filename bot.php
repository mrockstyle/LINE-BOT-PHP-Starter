	...
	foreach ($events['events'] as $event) {
		...
		if ($event['type'] == 'message' && $event['message']['type'] == 'text') {
			...
			if ($text == 'สวัสดี' || $text == 'หวัดดี') {
				...
				# code...
				$a = ['ติดสาว', 'แม่ทำกับข้าวไว้แล้วแน่ๆ เลยไม่มาตอบ', 'นราธิป เพื่อนเรียกแล้ว', 'ฮัลโหล นราธิป', 'เค้าไม่ตอบหรอกถ้าไม่ใช่สาวสวยพิมพ์ไปหา', 'นุ๊กแพรว นุ๊กแพรว นุ๊กแพรว นุ๊กแพรว นุ๊กแพรว นุ๊กแพรว นุ๊กแพรว นุ๊กแพรว นุ๊กแพรว นุ๊กแพรว นุ๊กแพรว นุ๊กแพรว'];
